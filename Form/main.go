...
//TODO 5. Сделать Тесты, которые будут независимы друг от друга

//TODO 6."Добавить возможность получить обратно данные по заявке" через авторизацию*
/*
Выполнено:
...
2."Добавить возможность получить обратно данные по заявке" По ID*
3. Сделать ручку для получения всех заявок с возможностью фильтрации
